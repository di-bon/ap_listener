...
fn create_simulation_controller_notifier() -> (Arc<SimulationControllerNotifier>, Receiver<NodeEvent>) {
...
fn create_listener(node_id: NodeId, simulation_controller_notifier: Arc<SimulationControllerNotifier>) -> (Listener, Receiver<LogicCommand>, Receiver<Message>, Sender<Packet>, Sender<ListenerCommand>) {
